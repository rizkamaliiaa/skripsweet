...
<head>
  ...
  <link href="{{url('template/assets/demo/demo.css" rel="stylesheet')}}" />
</head>
...
<body class="">
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="{{url('kontrol')}}">
  ...
  <script src="{{url('template/assets/js/plugins/jquery.dataTables.min.js')}}"></script>
  ...
  <script src="{{url('template/assets/js/plugins/jquery-jvectormap.js')}}"></script>
  ...
  <script src="{{url('template/assets/demo/demo.js')}}"></script> 
  @stack('js')
</body>
